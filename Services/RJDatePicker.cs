...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = CineNote.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = CineNote.Properties.Resources.calendarDark;
                else calendarIcon = CineNote.Properties.Resources.calendarWhite;
